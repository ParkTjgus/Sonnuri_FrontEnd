...
const StageCard = ({
    ...
    return (
        <article
            className="w-full flex flex-col md:flex-row justify-between gap-[46px] p-[24px]"
        >
            <header className="flex gap-[16px] items-center">
                ...
                <div className="flex flex-col">
                    <h4 className="text-[20px] font-semibold">{stage}. {title}</h4>
                    <h6 className="text-[14px]" style={{
                        color: 'gray',
                    }}>{description}</h6>
                </div>
            </header>
